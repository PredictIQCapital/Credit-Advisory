...
DOCUMENT_EN = {
    ...
    "jahresabschluesse": ("Annual accounts of the last 2-3 years", "Balance sheet, P&L and notes, one file per year.", "The basis of every credit decision and a mandatory part of any loan application.", ""),
